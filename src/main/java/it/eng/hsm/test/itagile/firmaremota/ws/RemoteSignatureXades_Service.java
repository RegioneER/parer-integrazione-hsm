...
/**
 * This class was generated by Apache CXF 2.7.14.redhat-1 2017-08-29T17:56:04.098+02:00 Generated
 * source version: 2.7.14.redhat-1
 *
 */
@WebServiceClient(name = "remoteSignatureXades", wsdlLocation = "https://test-firmaremota.ente.regione.emr.it/FirmaRemota/services/RemoteSignatureXades?wsdl", targetNamespace = "http://impl.ws.firmaremota.itagile.it/")
public class RemoteSignatureXades_Service extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://impl.ws.firmaremota.itagile.it/",
	    "remoteSignatureXades");
    public final static QName RemoteSignatureXadesPort = new QName(
	    "http://impl.ws.firmaremota.itagile.it/", "remoteSignatureXadesPort");
    static {
	URL url = null;
	try {
	    url = new URL(
		    "https://test-firmaremota.ente.regione.emr.it/FirmaRemota/services/RemoteSignatureXades?wsdl");
