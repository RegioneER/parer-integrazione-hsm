...
public class SignatureEvaluation {
    ...
    /**
     *
     * @param signature              wrapper firma
     * @param invalidSignDescription If the signature is valid sets <code>null</code>, otherwise the
     *                               invalidation description
     * @param certificateEvaluation  wrapper ceritificato
     */
