...
public class CertificateEvaluation {
     ...
     * @param verifyDate         data di verifica
     * @param invalidDesciption  If the certificate is valid sets <code>null</code>, otherwise the
     *                           invalidation description
     * @param untrustDescription If the certificate is trusted sets <code>null</code>, otherwise the
