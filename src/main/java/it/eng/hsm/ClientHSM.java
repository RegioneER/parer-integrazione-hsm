...
public interface ClientHSM {
     ...
     *
     * @param user utente HSM
     *
     * @return sessione con servizio HSM
     *
     * @throws AuthenticationException if the user credentials aren't correct
     * @throws OTPException            if the OTP value isn't correct
     * @throws UserBlockedException    if the user is blocked
     * @throws HSMException            if a generic error occurs
     */
     ...
     *
     * @param session sesione operativa HSM
     *
     * @throws it.eng.hsm.HSMException eccezione generica
     */
    ...
    /**
     * Realizes the CAdES signature of the <code>fileToSign</code> with the certificate of the
     * <code>user</code>.
     *
     * @param user           the user who requires the signature
     * @param fileToSign     file to sign
     * @param marcaTemporale true se si desidera aggiungere una marca temporale, false altrimenti
     *
     ...
     * <code>user</code>.
     *
     * @param session        the signature session has to be previously opened
     * @param fileToSign     file to sign
     * @param marcaTemporale true se si desidera aggiungere una marca temporale, false altrimenti
     *
     * @return array di byte del documento P7M firmato
    ...
    /**
     * Realizes the XAdES-T signature of the <code>fileToSign</code> with the certificate of the
     * <code>user</code>.
     *
     * @param user           the user who requires the signature
     * @param fileToSign     file to sign
     * @param marcaTemporale marca temporale si/no
     *
    ...
    /**
     * Realizes the XAdES signature of the <code>fileToSign</code> with the certificate of the
     * <code>user</code>.
     *
     * @param user       the user who requires the signature
     * @param fileToSign file to sign
     * @param conf       configurazione XADES
     *
     * @return array di byte del documento XADES firmato
     *
     * @throws AuthenticationException if the user credentials aren't correct
