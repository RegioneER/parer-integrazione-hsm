...
public class XAdESTest {
	...
	assertTrue(client.isXAdESActive());
    }

    // Test funzione signXAdES
    @Test
    void testSignXAdES_UserNull() {
    ...
    @Test
    void testSignXAdES_SessionNull() {
	assertThrows(IllegalArgumentException.class, () -> {
    ...
    @Test
    void testSignXAdES_FileNull() {
	HSMUser user = TestUtils.getWrongUserTest();
	assertThrows(IllegalArgumentException.class, () -> {
	    client.signXAdES(user, null, null);
	});
    }

    @Test
    void testSignXAdES_WrongUser() {
	HSMUser user = TestUtils.getWrongUserTest();
	assertThrows(IllegalArgumentException.class, () -> {
	    client.signXAdES(user, fileToSign, null);
	});
    }
	...
	try {
	    ConfigurationXAdES conf = new ConfigurationXAdES(XAdES.PROFILES.BES,
		    XAdES.TYPE.ENVELOPED, null);
